...
* **Databases:** SQL, NoSQL
* **IT & Networking:** Surveillance Systems (CCTV & IP), Software Troubleshooting, Systems Thinking, Server Maintenance
* **Productivity & Design:** Microsoft Office Suite (Advanced Word/PowerPoint, Proficient Excel/Access), Adobe Creative Cloud
...
* **Appreciation Certificate for Outstanding Contributions** – Minister of Kurdistan Region for Component Affairs *(Dec 2023)*
* **Successful Negotiation: Essential Strategies and Skills** – University of Michigan (Coursera) *(Jan 2020)*
* **Data Science Methodology** – IBM (Coursera) *(Apr 2020)*
* **Deep Learning with TensorFlow 2.0** – 365 Data Science *(Mar 2022)*
* **Customer Analytics in Python** – 365 Data Science
* **Tableau Complete Course** – 365 Data Science *(Mar 2020)*
* **Power BI Course Completion** – 365 Data Science *(Apr 2020)*
